<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentDetails.aspx.cs" Inherits="ApplicationWithDB.StudentDetails" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="RegNo" runat="server" Text="RegNo"></asp:Label>
